...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = 23331.591750122512; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 72076.1488058742; // x position of the perpendicular encoder (in tick units)
    }
